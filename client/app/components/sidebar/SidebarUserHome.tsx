...
export default function Sidebar({amountDataLoan,amountDataTaken}:any){
    return(
        <div className="grid mt-5 grid-rows-4 justify-center items-center text-left">
            <Button className="justify-start" variant="solid" color="primary"><MdHome /> Home</Button>
            <Button className="justify-start" variant="light" as={Link} href="/pages/users/barang" ><MdOutlineStorage />Daftar Barang</Button>
            <Badge content={amountDataLoan} ><Button className="justify-start" variant="light" as={Link} href="/pages/users/peminjaman"><MdOutlineShoppingCart />Peminjaman</Button> </Badge>
