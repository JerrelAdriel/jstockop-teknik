    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            <Button variant="solid" color="primary" className="justify-start w-full"
                ...
                endContent={<Counter value={amountDataLoan} color="primary" />}>
                Peminjaman
            </Button>
            <Button variant="light" as={Link} href="/pages/admin/pengambilan" className="justify-start w-full"
                startContent={<MdOutlineBackHand size={20} />}
                endContent={<Counter value={amountDataTaken} color="warning" />}>
                Pengambilan
            </Button>
        </div>
    );
